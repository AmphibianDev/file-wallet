...
function RiCopperCoinFill(props) {
  return GenIcon({ "tag": "svg", "attr": { "viewBox": "0 0 24 24" }, "child": [{ "tag": "path", "attr": { "d": "M12.0049 22.0029C6.48204 22.0029 2.00488 17.5258 2.00488 12.0029C2.00488 6.48008 6.48204 2.00293 12.0049 2.00293C17.5277 2.00293 22.0049 6.48008 22.0049 12.0029C22.0049 17.5258 17.5277 22.0029 12.0049 22.0029ZM12.0049 7.76029L7.76224 12.0029L12.0049 16.2456L16.2475 12.0029L12.0049 7.76029Z" } }] })(props);
}
function RiTwitterXLine(props) {
  return GenIcon({ "tag": "svg", "attr": { "viewBox": "0 0 24 24" }, "child": [{ "tag": "path", "attr": { "d": "M8 2H1L9.26086 13.0145L1.44995 21.9999H4.09998L10.4883 14.651L16 22H23L14.3917 10.5223L21.8001 2H19.1501L13.1643 8.88578L8 2ZM17 20L5 4H7L19 20H17Z" } }] })(props);
}
...
const NavBarCSS = {
  "dark-theme": "_dark-theme_1o05x_1",
...
const MiddleTruncate = ({
  ...
  let initDisplayedText = text2;
  if (text2.length > maxChars * 2 + 4) {
    const left = text2.substring(0, maxChars);
    const right = text2.substring(text2.length - maxChars);
    initDisplayedText = left + "..." + right;
  }
  const [displayedText, setDisplayedText] = reactExports.useState(initDisplayedText);
  ...
  }, [text2, minChars, maxChars]);
  return /* @__PURE__ */ jsxRuntimeExports.jsx("span", { ref: containerRef, style: { display: "block" }, ...spanProps, children: displayedText });
};
...
const getTruncatedText = (text2, effectiveWidth, fontStyle, minChars, maxChars) => {
  let chars = minChars;
  const middle2 = "...";
  while (true) {
    const left2 = text2.substring(0, chars);
    const right2 = text2.substring(text2.length - chars);
    const currentWidth = getTextWidth(left2 + middle2 + right2, fontStyle);
    if (currentWidth <= effectiveWidth && chars * 2 < text2.length && chars <= maxChars) {
      chars++;
    } else {
      if (chars > minChars)
        chars--;
  ...
  const left = text2.substring(0, chars);
  const right = text2.substring(text2.length - chars);
  return left + middle2 + right;
};
...
const useInfoPopupStore = create((set) => ({
  toggleFlag: true,
  isOpen: false,
  message: "",
  icon: void 0,
  iconColor: void 0,
  closeDelay: 1e3,
  openPopup: (message, type, closeDelay = 1e3) => {
...
const FooterCSS = {
  "dark-theme": "_dark-theme_e9pko_1",
...
const Footer = () => {
  ...
  const myMoneroAddress = "83PVCBCyANzZzBjNtpCkM6bT88DBY5icMNZycyJm93QzLoizCwGvd8zM7ShMNhUac82QQFeAx1TCbh9Ljff423U1Tt585qs";
  const handleCopy = () => {
    navigator.clipboard.writeText(myMoneroAddress).then(() => {
      openPopup("copied", "success", 1e3);
    }).catch((error) => {
      console.error("Failed to copy text: ", error);
      openPopup("failed to copy", "error", 1e3);
    });
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { className: FooterCSS.container, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: FooterCSS.text, children: [
...
const InputField = ({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: type === "password" ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: InputFieldCSS.container, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "input",
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        ...
        children: showText ? /* @__PURE__ */ jsxRuntimeExports.jsx(AiFillEyeInvisible, {}) : /* @__PURE__ */ jsxRuntimeExports.jsx(AiFillEye, {})
      }
    )
  ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("input", { className: InputFieldCSS.input, type, ...props }) });
};
const useCryptoIconStore = create((set, get) => ({
  availableIcons: /* @__PURE__ */ new Set(),
  isFetching: false,
  fetchAvailableIcons: () => {
    if (get().isFetching || get().availableIcons.size > 0)
      return;
    set({ isFetching: true });
    fetch("https://cdn.jsdelivr.net/npm/cryptocurrency-icons/manifest.json").then((response) => response.json()).then((manifest) => {
      const iconsSet = new Set(
        manifest.map(
          (icon2) => icon2.symbol.toUpperCase()
        )
      );
...
const CryptoIcon = ({
  ...
  const [isVisible, setIsVisible] = reactExports.useState(alwaysVisible);
  const [isImageLoaded, setIsImageLoaded] = reactExports.useState(false);
  ...
  reactExports.useEffect(() => {
    const observer = new IntersectionObserver(
      ...
      { root: scrollParentRef == null ? void 0 : scrollParentRef.current, rootMargin: "0px 0px 200px 0px" }
    );
  ...
  if (!isVisible || !availableIcons.has(iconName.toUpperCase()) || !isImageLoaded)
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { ref: placeholderRef, className, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      RiCopperCoinFill,
      {
...
const panel = "_panel_15as5_1";
const slideIn = "_slideIn_15as5_1";
const closing = "_closing_15as5_22";
const slideOut = "_slideOut_15as5_1";
const btn$1 = "_btn_15as5_1";
const ModalCSS = {
  panel,
  slideIn,
  closing,
...
const Modal = ({ children, open, onClose }) => {
  const [closing2, setClosing] = reactExports.useState(false);
  ...
  reactExports.useEffect(() => {
    const handleClickOutside = (e2) => {
      if (e2.target === dialogRef.current)
        close();
    };
...
const CryptoListModal = ({ open, onClose }) => {
  ...
  const handleSearchTextChange = (str) => {
    var _a;
    (_a = ulRef.current) == null ? void 0 : _a.scrollTo(0, 0);
    setSearchText(str);
  };
  const handleClose = () => {
  ...
  const items = reactExports.useMemo(() => {
    const filteredItems = window.networksNames.filter(
      (item2) => item2.toLocaleLowerCase().includes(searchText.toLocaleLowerCase())
    );
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    Modal,
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: CryptoListCSS.container, role: "search", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          InputField,
          {
            type: "search",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "ul",
          {
            ...
            role: "listbox",
            tabIndex: -1,
            children: items.map((item2) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              ListItem,
              {
                parentRef: ulRef,
                label: item2,
                selected: cryptoName === item2,
                onClick: () => {
                  setCrypto(item2);
                  handleClose();
                }
...
const ListItem = ({ parentRef, label: label2, selected, onClick }) => {
  const [cryptoTicker, cryptoFullName] = label2.split(" - ");
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "li",
    {
      onClick,
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: CryptoListCSS.itemText, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { children: cryptoFullName }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: cryptoTicker })
        ] })
      ]
    }
  );
...
const CryptoBtn = ({ cryptoName, ...props }) => {
      ...
      "button",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            CryptoIcon,
            {
              iconName: (cryptoTicker == null ? void 0 : cryptoTicker.toLowerCase()) ?? "",
              resolution: "128",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: CryptoBtnCSS.text, children: cryptoFullName })
        ]
      }
    )
  ] });
...
function fromEvent(evt) {
  return __awaiter(this, void 0, void 0, function() {
    return __generator(this, function(_a) {
      ...
      } else if (Array.isArray(evt) && evt.every(function(item2) {
        return "getFile" in item2 && typeof item2.getFile === "function";
      })) {
    ...
    return __generator(this, function(_a) {
      switch (_a.label) {
        case 0:
          if (!dt.items)
            return [3, 2];
          items = fromList(dt.items).filter(function(item2) {
...
function toFilePromises(item2) {
  if (typeof item2.webkitGetAsEntry !== "function") {
    return fromDataTransferItem(item2);
  }
  var entry = item2.webkitGetAsEntry();
...
function fromDataTransferItem(item2) {
  var file = item2.getAsFile();
  if (!file) {
    return Promise.reject("".concat(item2, " is not a File"));
  }
...
var getInvalidTypeRejectionErr = function getInvalidTypeRejectionErr2(accept2) {
  accept2 = Array.isArray(accept2) && accept2.length === 1 ? accept2[0] : accept2;
  var messageSuffix = Array.isArray(accept2) ? "one of ".concat(accept2.join(", ")) : accept2;
  return {
...
function fileAccepted(file, accept2) {
  var isAcceptable = file.type === "application/x-moz-file" || _default(file, accept2);
  return [isAcceptable, isAcceptable ? null : getInvalidTypeRejectionErr(accept2)];
}
...
function allFilesAccepted(_ref) {
  var files = _ref.files, accept2 = _ref.accept, minSize = _ref.minSize, maxSize = _ref.maxSize, multiple = _ref.multiple, maxFiles = _ref.maxFiles, validator = _ref.validator;
  if (!multiple && files.length > 1 || multiple && maxFiles >= 1 && files.length > maxFiles) {
    return false;
  }
  return files.every(function(file) {
    var _fileAccepted = fileAccepted(file, accept2), _fileAccepted2 = _slicedToArray$1(_fileAccepted, 1), accepted = _fileAccepted2[0];
...
function pickerOptionsFromAccept(accept2) {
  if (isDefined(accept2)) {
    var acceptForPicker = Object.entries(accept2).filter(function(_ref2) {
...
function acceptPropAsAcceptAttr(accept2) {
  if (isDefined(accept2)) {
    return Object.entries(accept2).reduce(function(a, _ref6) {
...
function useDropzone() {
  ...
  var _defaultProps$props = _objectSpread(_objectSpread({}, defaultProps), props), accept2 = _defaultProps$props.accept, disabled = _defaultProps$props.disabled, getFilesFromEvent = _defaultProps$props.getFilesFromEvent, maxSize = _defaultProps$props.maxSize, minSize = _defaultProps$props.minSize, multiple = _defaultProps$props.multiple, maxFiles = _defaultProps$props.maxFiles, onDragEnter = _defaultProps$props.onDragEnter, onDragLeave = _defaultProps$props.onDragLeave, onDragOver = _defaultProps$props.onDragOver, onDrop = _defaultProps$props.onDrop, onDropAccepted = _defaultProps$props.onDropAccepted, onDropRejected = _defaultProps$props.onDropRejected, onFileDialogCancel = _defaultProps$props.onFileDialogCancel, onFileDialogOpen = _defaultProps$props.onFileDialogOpen, useFsAccessApi = _defaultProps$props.useFsAccessApi, autoFocus = _defaultProps$props.autoFocus, preventDropOnDocument = _defaultProps$props.preventDropOnDocument, noClick = _defaultProps$props.noClick, noKeyboard = _defaultProps$props.noKeyboard, noDrag = _defaultProps$props.noDrag, noDragEventsBubbling = _defaultProps$props.noDragEventsBubbling, onError = _defaultProps$props.onError, validator = _defaultProps$props.validator;
  var acceptAttr = reactExports.useMemo(function() {
    return acceptPropAsAcceptAttr(accept2);
  }, [accept2]);
  var pickerTypes = reactExports.useMemo(function() {
    return pickerOptionsFromAccept(accept2);
  }, [accept2]);
  ...
  }, [inputRef, accept2, multiple, onDropCb, disabled]);
...
const DropZone = ({ file, onChange }) => {
  ...
  const onDrop = reactExports.useCallback(
    (files) => {
      ...
      reader.onabort = () => openPopup("file reading was aborted", "error", 2e3);
      reader.onerror = () => openPopup("file reading was failed", "error", 2e3);
      reader.onload = () => {
        var _a;
        const result = (_a = reader.result) == null ? void 0 : _a.toString();
        if (result)
          onChange({ name: file2.name, dataUrl: result });
      };
  ...
  const onDropRejected = (fileRejections) => {
    ...
    if (fileRejections[0])
      openPopup(getErrorMessage(fileRejections[0].errors), "error", 2e3);
  };
...
const TextZone = ({ value, onChange }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: TextZoneCSS.container, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    "textarea",
    {
      ...
      ref,
      value,
      onChange: (e2) => onChange(cleanString(e2.target.value))
    }
  ) });
};
...
const tabs = "_tabs_m7kg9_3";
const tab = "_tab_m7kg9_3";
const leftTab = "_leftTab_m7kg9_56";
...
const InputSectionCSS = {
  ...
  "light-theme": "_light-theme_m7kg9_1",
  "sr-only": "_sr-only_m7kg9_1",
  "x-btn": "_x-btn_m7kg9_1",
  tabs,
  tab,
  leftTab,
  rightTab,
...
const InputSection = ({ className }) => {
  const { cryptoName, bipFromFile, bipFromMnemonic, bipRandom, bipReset } = useCryptoStore();
  ...
  const memoGenerateBip = reactExports.useCallback(() => {
    if (fileData)
      bipFromFile(fileData.dataUrl, password);
    if (mnemonic)
      bipFromMnemonic(mnemonic);
  }, [fileData, password, mnemonic, bipFromFile, bipFromMnemonic]);
  const memoGenerateRef = reactExports.useRef(memoGenerateBip);
  reactExports.useEffect(() => {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "File" })
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "Seed" })
            }
          )
        ]
      }
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(DropZone, { file: fileData, onChange: setFileData })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
...
const useQRCodeModalStore = create((set) => ({
  isOpen: false,
  message: "",
...
const box$1 = "_box_hic01_69";
const text$2 = "_text_hic01_79";
...
const MnemonicFiled = ({ bip39, xmr: xmr2 }) => {
  const [isXMR, setIsXMR] = reactExports.useState(Boolean(xmr2));
  reactExports.useEffect(() => {
    setIsXMR(Boolean(xmr2));
  }, [xmr2]);
  const { openPopup } = useInfoPopupStore();
  const handleCopy = reactExports.useCallback(() => {
    const value = isXMR ? xmr2 : bip39;
    if (!value)
      return;
  ...
  reactExports.useEffect(() => {
    ...
    currentSpan == null ? void 0 : currentSpan.addEventListener("copy", copy);
    return () => {
      currentSpan == null ? void 0 : currentSpan.removeEventListener("copy", copy);
    };
  }, [handleCopy]);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: MnemonicFiledCSS.container, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { style: xmr2 ? { marginBottom: "0.4rem" } : {}, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: MnemonicFiledCSS.label, children: "Mnemonic Seed" }),
      xmr2 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: MnemonicFiledCSS.bip, children: "BIP" })
          ]
        }
      )
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: MnemonicFiledCSS.box, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { ref: spanRef, className: MnemonicFiledCSS.text, children: isXMR ? xmr2 : bip39 }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: MnemonicFiledCSS.buttons, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
...
const OutputFiled = ({ text: text2, label: label2 }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: OutputFiledCSS.container, children: [
    label2 && /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: OutputFiledCSS.label, children: label2 }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref: divRef, className: OutputFiledCSS.box, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        MiddleTruncate,
        {
  ...
  const outJSX = (bip39Info2) => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        MnemonicFiled,
        {
          bip39: bip39Info2.bip39Mnemonic,
          xmr: bip39Info2.xmrMnemonic
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(OutputFiled, { label: "Address", text: bip39Info2.wallets[0].address }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        OutputFiled,
        {
          label: bip39Info2.xmrMnemonic ? "Secret View Key" : "Public Key",
          text: bip39Info2.wallets[0].pubkey
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        OutputFiled,
        {
          label: bip39Info2.xmrMnemonic ? "Secret Spend Key" : "Private Key ",
          text: bip39Info2.wallets[0].privkey
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: OutputSectionCSS.downArrow, children: /* @__PURE__ */ jsxRuntimeExports.jsx(AiFillCaretDown, {}) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: OutputSectionCSS.advanceContainer, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          OutputFiled,
          {
            label: "Master Public Key",
            text: bip39Info2.accountExtendedPubKey
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          OutputFiled,
          {
            ...
            text: bip39Info2.accountExtendedPrvKey
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(OutputFiled, { label: "Entropy", text: bip39Info2.entropy }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(OutputFiled, { label: "Bip39 Seed", text: bip39Info2.bip39Seed }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(OutputFiled, { label: "Bip32 Root Key", text: bip39Info2.bip32RootKey })
      ] })
    ] });
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className, children: [
...
const WarningAside = () => {
  const [showWarning, setShowWarning] = reactExports.useState(
...
const Home = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: HomeCSS.container, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(WarningAside, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: HomeCSS.mainContainer, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(InputSection, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(OutputSection, {})
    ] })
  ] });
};
...
const Accordion = ({ title: title2, children }) => {
  ...
  reactExports.useEffect(() => {
    ...
    if (focusableElements) {
      Array.from(focusableElements).forEach((el2) => {
        if (isOpen) {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "x-btn" })
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
...
const FAQ = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: FAQCSS.container, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Accordion, { title: "Why Use It?", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("ol", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
          "1. ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Hidden in Plain Sight:" }),
          " Your file can be any ordinary image or document that can be stored on any device, disguising its critical role in the wallet creation."
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
          "2. ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Versatility Against Threats:" }),
          ` By changing the password, one file can be the source of multiple wallets. It's virtually impossible to determine how many wallets, if any, originated from a single file. This obscures potential theft attempts, including the so-called "$5 wrench attack".`
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
          "3. ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Memorability:" }),
          " It's easier to recall an image and a chosen password than to remember a randomized 24-word seed."
        ] }) })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Accordion, { title: "How Does It Work?", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("ol", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "1. The chosen file is transformed into a data URL (a string representation)." }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "2. If a password is added, it's attached to the end of this string." }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
          "3. The concatenated string is hashed using SHA-256, which then becomes the entropy for the wallet generation. The wallet generation code is sourced from",
          " ",
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "a",
            {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Accordion, { title: "How to Stay Safe?", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("ol", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
        "1. ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "File Integrity:" }),
        " Ensure the file hasn't been compressed after you've used it to generate a wallet. It must remain unchanged, byte-for-byte. This is especially crucial for images; popular messaging apps tend to compress them, which would make them completely different to the wallet generator."
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
        "2. ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Password Selection:" }),
        ` It's crucial to use a password. Phrases, long but memorable, are recommended. For example: "My 3.14 dog thinks about 42 :)." Relating the phrase to the image can aid recall, but adding at least one random number and a special character is a must.`
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
        "3. ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Device Trustworthiness:" }),
        " Only use this website on devices you trust and preferably offline."
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
        "4. ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "QR Code Precaution:" }),
        " If you use the QR Code, you need to be careful, some scanner devices may store the scan history."
      ] }) })
    ] }) }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Accordion, { title: "Is The Code Open-Source?", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
      ...
      " ",
      "and even contribute. Your insights and improvements are extremely valuable. And reviewing the code also allows you to verify its legitimacy."
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Accordion, { title: "Disclaimer", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
      "Use this project at your own risk. The developers are not liable for any loss of cryptocurrency or other damages. Ensure file integrity and only use it on trusted devices. Review the open-source code on",
      " ",
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "a",
        {
...
const popupContainer = "_popupContainer_f9k5w_1";
const fadeInScale = "_fadeInScale_f9k5w_1";
const popupClose = "_popupClose_f9k5w_35";
const fadeOutScale = "_fadeOutScale_f9k5w_1";
const InfoPopupCSS = {
  popupContainer,
  fadeInScale,
  popupClose,
...
function QRCodeCanvas(props) {
  ...
  reactExports.useEffect(() => {
    if (_canvas.current != null) {
      ...
      if (haveImageToRender) {
        ctx.drawImage(image2, calculatedImageSettings.x + margin, calculatedImageSettings.y + margin, calculatedImageSettings.w, calculatedImageSettings.h);
      }
    }
  });
  reactExports.useEffect(() => {
...
const QRCodeModal = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Modal, { open: isOpen, onClose: closeQRCodeModal, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "sr-only", children: "QR Code Modal" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      QRCodeCanvas,
      {
        value: message,
...
const LoadingScreen = ({ isDone }) => {
  ...
  if (isClosed)
    return null;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: LoadingScreenCSS.container, "data-closing": isDone, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "sr-only", children: "Loading the page" }),
...
function App() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    ...
    isLoaded && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: AppCSS.container, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(QRCodeModal, {}),
